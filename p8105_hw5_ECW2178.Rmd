...
The plot shows that power increases when the sample size and effect size is larger.

The sample average of mu across tests for which the null is not rejected approximately equal to the true value of mu because the estimates aren't filtered by statistical significance and aren't subjected to selection bias. 
